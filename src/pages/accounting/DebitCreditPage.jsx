  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">Debitor / Kreditor</h1>
          <p className="text-sm text-gray-400">Müştəri borclarının incələnməsi və ödəniş təqibi</p>
        </div>
      </div>
