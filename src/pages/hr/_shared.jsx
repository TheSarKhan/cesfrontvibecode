/* ─────────────────────────────────────────────────────
   CES ERP HR — Shared UI kit components
   Reused across all HR pages and modals.
   Pure components only (non-component exports live in _constants.js)
───────────────────────────────────────────────────── */
  ...
  return (
    <div className="flex items-start justify-between gap-4 flex-wrap mb-5">
      <div>
        ...
        {subtitle && (
          <p className="text-[13px] mt-1.5" style={{ color: 'var(--ces-muted)' }}>{subtitle}</p>
        )}
      </div>
...
/* ─── UI kit `.input` ─── */
export function Input({ value, onChange, placeholder, type = 'text', error, prefix, suffix, autoFocus, min, max, step, maxLength, disabled, onKeyDown, onPaste, inputMode }) {
...
/* ─── Form section with icon eyebrow ─── */
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-3">
        {Icon && (
          <span
            className="w-6 h-6 rounded-[6px] grid place-items-center"
