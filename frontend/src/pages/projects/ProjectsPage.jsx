...
import { Search, Clock, Zap, CheckCircle, TrendingUp, ChevronRight, FileText } from 'lucide-react'
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={8} className="py-14 text-center text-sm text-gray-400">
                    {projects.length === 0
                      ? 'Hələ layihə yoxdur. Koordinator sorğu qəbul etdikdən sonra layihələr burada görünəcək.'
